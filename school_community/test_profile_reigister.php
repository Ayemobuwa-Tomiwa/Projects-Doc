...
if (isset($_SESSION['id'])) {
    header("Location:test_profile_home.php");
}
...
if (isset($_POST['register'])){
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        $query = "INSERT INTO profile (firstname, lastname, age, matric, department, college, email, dateofbirth) VALUES 
        ('$firstname', '$lastname','$age','$matric','$department','$college', '$email', '$dateofbirth')";
        ...
        if($result == true){
            ...
            $errorMsg = "No information found.. Please Try Again!";
        }
